...
public class BB10SlideMenuItemAdapter extends BaseAdapter {
    ...
    public BB10SlideMenuItemAdapter(Context c, ArrayList<BB10SlideMenuItem> menuItems, int selected) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        BB10SlideMenuItem item = menuItems.get(position);
        ...
        if (item.getIcon() != BB10SlideMenuItem.NO_ICON) {
